...
- Name: qa-automation\tests\stage6.security-access.spec.js >> Stage 6 - Security & Access Testing >> check restricted pages, unauthenticated API access, and weak password handling
- Location: qa-automation\tests\stage6.security-access.spec.js:22:3
